...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_guid_typescript__ = __webpack_require__(420);
...
/* unused harmony export ConsultarAction */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ConsultarActionClientes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return ConsultarActionPrecios; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ConsultarActionParametros; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ConsultarActionArticulos; });
/* harmony export (immutable) */ __webpack_exports__["h"] = conceptoReducer;
/* harmony export (immutable) */ __webpack_exports__["g"] = clientesreducer;
/* harmony export (immutable) */ __webpack_exports__["j"] = preciosreducer;
/* harmony export (immutable) */ __webpack_exports__["i"] = parametrosreducer;
/* harmony export (immutable) */ __webpack_exports__["b"] = ArticulosReducer;
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
...
var ConsultarActionClientes = /** @class */ (function () {
    function ConsultarActionClientes() {
...
var ConsultarActionPrecios = /** @class */ (function () {
    function ConsultarActionPrecios() {
...
var ConsultarActionParametros = /** @class */ (function () {
    function ConsultarActionParametros() {
...
var ConsultarActionArticulos = /** @class */ (function () {
    function ConsultarActionArticulos() {
        this.type = ActionTypes.ARTICULOS_CONSULTAR;
    }
    return ConsultarActionArticulos;
}());
...
function ArticulosReducer(state, action) {
    if (state === void 0) { state = initialStateArticulos; }
    switch (action.type) {
        case ActionTypes.ARTICULOS_CONSULTAR:
            return __assign({}, state, { loading: true });
        case ActionTypes.ARTICULOS_SUCCES:
            return __assign({}, state, { articulos: action.articulos, error: false, loading: false });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_observable_fromPromise__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__buscar_buscar__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ngrx_store__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__rdxbuscar_ReducerBuscar__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__buscar_buscar__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngrx_store__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rdxbuscar_ReducerBuscar__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_app_clases__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_qr_scanner__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WebviewPage = /** @class */ (function () {
    ...
    WebviewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-webview',template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\webview\webview.html"*/'<!--\n  Generated template for the WebviewPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>webview</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content paddingm>\n	<input type="text"  [(ngModel)]="qrCode"  >\n	<button ion-button item-end  (click)="readQr()">Leer Código Qr</button>    \n</ion-content>\n'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\webview\webview.html"*/,
        }),
...
var UserListPage = /** @class */ (function () {
    ...
    UserListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-user-list',template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\user-list\user-list.html"*/'<!--\n  Generated template for the UserListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Listado de usuarios</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list>\n    <button ion-item *ngFor="let user of users" (click)="userSelected(user)">\n      {{ user.Nombre }}\n    </button>  \n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\user-list\user-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ngrx_store__["b" /* Store */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */]])
    ], UserListPage);
    return UserListPage;
}());
...
var SincronizarPage = /** @class */ (function () {
        ...
        this.opcionessincronziacion.forEach(function (opcion) {
            if (opcion.sincronizar && opcion.name != '') {
                if (opcion.name == 'clientes' && opcion.enabled) {
                    _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__redux_z_reducer__["d" /* ConsultarActionClientes */]());
                }
                if (opcion.name == 'conceptos' && opcion.enabled) {
                    _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__redux_z_reducer__["c" /* ConsultarActionArticulos */]());
                }
                if (opcion.name == 'precios' && opcion.enabled) {
                    _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__redux_z_reducer__["f" /* ConsultarActionPrecios */]());
                }
                if (opcion.name == 'parametros' && opcion.enabled) {
                    _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__redux_z_reducer__["e" /* ConsultarActionParametros */]());
                }
            }
        });
    };
    ...
    SincronizarPage.prototype.subscripcionProductos = function () {
        var _this = this;
        this.store.select('estadoArticulos').subscribe(function (estado) {
            try {
                if (!estado.loading) {
                    _this.cargarstorage('SysArticulos', estado.articulos);
                    _this.opcionessincronziacion[1].terminado = true;
                    _this.terminarcarga();
                }
            }
    ...
    SincronizarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-sincronizar',template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\sincronizar\sincronizar.html"*/'<!--\n  Generated template for the SincronizarPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Sincronizar</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n  <ion-list>\n\n    <ion-list-header>\n      Obtener datos del servidor\n    </ion-list-header>\n    <!-- <pre>\n      {{opcionessincronziacion|json}}\n    </pre> -->\n    <ion-item *ngFor=\'let opcion of opcionessincronziacion\'>\n      <ion-toggle [checked]="opcion.sincronizar"></ion-toggle>\n      <ion-label>\n        {{opcion.titulo}}\n      </ion-label>\n      <ion-icon *ngIf="opcion.terminado" name=\'checkmark\' color="secondary" item-start></ion-icon>\n      <ion-icon  [name]=\'opcion.icono\' item-start></ion-icon>\n    </ion-item>\n\n    <ion-item>\n      <button ion-button   item-end   (click)="sincronizaritems()">\n        SINCRONIZAR\n      </button>\n      <button ion-button   item-end color="danger"  (click)="cerrarpagina()">\n          CERRAR\n      </button>\n    </ion-item>\n\n\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\sincronizar\sincronizar.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__ngrx_store__["b" /* Store */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ngrx_store__["b" /* Store */]) === "function" && _e || Object])
    ], SincronizarPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_mergeMap__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_fromPromise__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_zeusHttpClient__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_storage__ = __webpack_require__(21);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.list = function () {
        return this.http.Get('/api/users').map(function (response) {
            // console.log(response);
            return response;
        })
            .catch(function (err) {
    ...
    UserService.prototype.getByLogin = function (login) {
        return this.http.Get('/api/users/' + login).map(function (response) {
            // console.log(response);
            return response;
        })
            .catch(function (err) {
    ...
    UserService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__services_zeusHttpClient__["a" /* ZeusHttpClient */], __WEBPACK_IMPORTED_MODULE_6__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_7__services_outh2_service__["a" /* Outh2Service */]])
    ], UserService);
    return UserService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_zeusHttpClient__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_toPromise__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_toPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_toPromise__);
...
var SyncService = /** @class */ (function () {
    ...
    //consultar conceptos! 
    SyncService.prototype.consultar = function (op) {
        if (op === void 0) { op = "CUSTOMERS"; }
        return this.http.Get('/api/sync?op=' + op).map(function (response) {
            return response;
        })
            .catch(function (err) {
    ...
    SyncService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_zeusHttpClient__["a" /* ZeusHttpClient */]])
    ], SyncService);
    return SyncService;
}());
...
var InappBrowerPage = /** @class */ (function () {
    ...
    InappBrowerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-inapp-brower',template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\inapp-brower\inapp-brower.html"*/'<!--\n  Generated template for the InappBrowerPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>inappBrower</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\inapp-brower\inapp-brower.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], InappBrowerPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_buscar_buscar__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ngrx_effects__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__angular_http__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__rdxuser_user_reducer__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__rdxbuscar_ReducerBuscar__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__rdxuser_user_service__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__rdxuser_user_effects__ = __webpack_require__(705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__rdxpedidos_ReducerPedido__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__rdxpedidos_pedido_service__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__rdxpedidos_pedido_effects__ = __webpack_require__(706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__directives_zformat_zformat__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__directives_zeus_zeus__ = __webpack_require__(708);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_brmasker_ionic_3__ = __webpack_require__(710);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__directives_uppercase_uppercase__ = __webpack_require__(713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__redux_z_effects__ = __webpack_require__(714);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__redux_z_service__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_sincronizar_sincronizar__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__ionic_native_qr_scanner__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__ionic_native_in_app_browser__ = __webpack_require__(715);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__ionic_native_vibration__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_inapp_brower_inapp_brower__ = __webpack_require__(387);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__angular_common_http__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__services_zeusHttpClient__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__services_outh2_service__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__interceptors_token_interterceptor__ = __webpack_require__(716);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_user_list_user_list__ = __webpack_require__(178);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__ngrx_store__["d" /* StoreModule */].forRoot({
                    ...
                    estadoconceptos: __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__["h" /* conceptoReducer */],
                    estadoclientes: __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__["g" /* clientesreducer */],
                    estadoprecios: __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__["j" /* preciosreducer */],
                    estadoparametros: __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__["i" /* parametrosreducer */],
                    estadoArticulos: __WEBPACK_IMPORTED_MODULE_30__redux_z_reducer__["b" /* ArticulosReducer */],
                }),
                ...
                __WEBPACK_IMPORTED_MODULE_16__ngrx_effects__["c" /* EffectsModule */].forRoot([__WEBPACK_IMPORTED_MODULE_21__rdxuser_user_effects__["a" /* UserEffects */], __WEBPACK_IMPORTED_MODULE_24__rdxpedidos_pedido_effects__["a" /* PedidosEffects */], __WEBPACK_IMPORTED_MODULE_29__redux_z_effects__["a" /* SyncEffects */]]),
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_31__redux_z_service__["a" /* SyncService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_sincronizar_sincronizar__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_user_list_user_list__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_recordpedido_recordpedido__ = __webpack_require__(174);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen, store) {
        ...
        this.store = store;
        this.rootPage = __WEBPACK_IMPORTED_MODULE_12__pages_recordpedido_recordpedido__["a" /* RecordpedidoPage */];
        this.nameuser = '';
        this.emailuser = '';
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\app\app.html"*/'<ion-menu [content]="content" *ngIf="nameuser!=\'\'">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content>\n    <ion-item>\n      <ion-avatar item-start>\n        <img [src]="imagenuser">\n      </ion-avatar>\n      <h2>{{nameuser}}</h2>\n      <p>{{emailuser}}</p>\n    </ion-item>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        <ion-icon  name={{p.icono}}></ion-icon>\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n</ion-menu>\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\app\app.html"*/,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_vibration__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_storage__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(platform, menu, navParams, navCtrl, store, vibration, _storage, toastCtrl) {
        ...
        this.username = 'CALIXTO'; //'ebarrios@zeus.co';//
        this.password = '1261121122221222'; //'Zeustec18*'; //
        this.press = 0;
        this.swipe = 0;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngrx_effects__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rdxuser_user_reducer__ = __webpack_require__(63);
...
var UserEffects = /** @class */ (function () {
    ...
    UserEffects = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["a" /* Actions */],
            __WEBPACK_IMPORTED_MODULE_4__rdxuser_user_service__["a" /* UserService */]])
    ], UserEffects);
    return UserEffects;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ngrx_effects__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rdxpedidos_pedido_service__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngrx_store__ = __webpack_require__(24);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Input__ = __webpack_require__(709);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SyncEffects; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngrx_effects__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__redux_z_service__ = __webpack_require__(386);
...
var SyncEffects = /** @class */ (function () {
    function SyncEffects(actions, syncService) {
        var _this = this;
        this.actions = actions;
        ...
        this.consultarconcepto = this.actions.ofType(__WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].CONSULTAR)
            .map(function (action) { return action; })
            .switchMap(function (action) { return _this.syncService.consultar(action.type)
            .map(function (response) { return ({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].SUCCESS, concepto: (response) }); })
        ...
        this.consultarclientes = this.actions.ofType(__WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].CLIENTES_CONSULTAR)
            .map(function (action) { return action; })
            .switchMap(function (action) { return _this.syncService.consultar(action.type)
            .map(function (response) { return ({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].CLIENTES_SUCCES, oclientes: (response) }); })
        ...
        this.consultarprecios = this.actions.ofType(__WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].PRECIOS_CONSULTAR)
            .map(function (action) { return action; })
            .switchMap(function (action) { return _this.syncService.consultar(action.type)
            .map(function (response) { return ({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].PRECIOS_SUCCES, oprecios: (response) }); })
        ...
        this.consultarArticulos = this.actions.ofType(__WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].ARTICULOS_CONSULTAR)
            .map(function (action) { return action; })
            .switchMap(function (action) { return _this.syncService.consultar(action.type)
            .map(function (response) { return ({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].ARTICULOS_SUCCES, articulos: (response) }); })
            .catch(function () { return __WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"].of({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].ARTICULOS_ERROR }); }); });
        ...
        this.consultarParametros = this.actions.ofType(__WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].PARAMETROS_CONSULTAR)
            .map(function (action) { return action; })
            .switchMap(function (action) { return _this.syncService.consultar(action.type)
            .map(function (response) { return ({ type: __WEBPACK_IMPORTED_MODULE_4__z_reducer__["a" /* ActionTypes */].PARAMATEROS_SUCCES, oparamtros: (response) }); })
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["b" /* Effect */])(),
        __metadata("design:type", Object)
    ], SyncEffects.prototype, "consultarconcepto", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["b" /* Effect */])(),
        __metadata("design:type", Object)
    ], SyncEffects.prototype, "consultarclientes", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["b" /* Effect */])(),
        __metadata("design:type", Object)
    ], SyncEffects.prototype, "consultarprecios", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["b" /* Effect */])(),
        __metadata("design:type", Object)
    ], SyncEffects.prototype, "consultarArticulos", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["b" /* Effect */])(),
        __metadata("design:type", Object)
    ], SyncEffects.prototype, "consultarParametros", void 0);
    SyncEffects = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["a" /* Actions */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ngrx_effects__["a" /* Actions */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__redux_z_service__["a" /* SyncService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__redux_z_service__["a" /* SyncService */]) === "function" && _b || Object])
    ], SyncEffects);
    return SyncEffects;
    var _a, _b;
}());
...
var BuscarPage = /** @class */ (function () {
    ...
    BuscarPage.prototype.obtenerlistaproductos = function () {
        ...
        try {
            this.storage.get('SysArticulos').then(function (val) {
                //obteniendo conceptos y armando estructura de items.
                _this.lstitemsshow = [{ iditem: null, descripcion: null, dato: null }];
                //armando estructura de objetos para busqueda!
                if (val != null) {
                    val.forEach(function (element) {
                        _this.lstitemsshow.push({ iditem: element.IdArticulo, descripcion: element.Nombre, dato: element });
                    });
                }
                //eliminado primer registro del array en null;
                _this.lstitemsshow.shift();
    ...
    BuscarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-buscar',template:/*ion-inline-start:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\buscar\buscar.html"*/'<!--\n  Generated template for the BuscarPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{clasebusqueda}}</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n    <ion-fab top right edge (click)="closepagina()">\n        <button  color="danger"  ion-fab mini><ion-icon name="close"  ></ion-icon></button>\n      </ion-fab>\n\n    <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n    <ion-list>\n      <button ion-item *ngFor="let item of lstitemsshow" (click)="seleccionaritems(item)">\n        {{ item.descripcion }}\n      </button>\n    </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\tfs\ZeusBackOffice\ZOLBackOffice\Mobile\Dev\Mobile\src\pages\buscar\buscar.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__ngrx_store__["b" /* Store */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ngrx_store__["b" /* Store */]) === "function" && _d || Object])
    ], BuscarPage);
    return BuscarPage;
    var _a, _b, _c, _d;
}());
